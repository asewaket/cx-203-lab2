...
HD_PWD='/home/it/Chip_Design/CommonCore/DigitalDesign/Labs/Lab2/cx-203-lab2-t2/cx-203-lab2-t2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log half_adder_t2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source half_adder_t2.tcl
