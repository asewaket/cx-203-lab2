...
HD_PWD='/home/it/Chip_Design/CommonCore/DigitalDesign/Labs/Lab2/cx-203-lab2-t3/cx-203-lab2-t3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_t3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_t3.tcl
