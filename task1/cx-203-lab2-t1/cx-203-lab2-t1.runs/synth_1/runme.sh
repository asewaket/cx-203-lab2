...
HD_PWD='/home/it/Chip_Design/CommonCore/DigitalDesign/Labs/Lab2/cx-203-lab2-t1/cx-203-lab2-t1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and4gate_l2t1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and4gate_l2t1.tcl
